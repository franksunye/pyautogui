...
# 2025年2月，北京. 幸运数字8，单合同金额1万以上和以下幸运奖励不同；节节高三档；合同累计考虑工单合同金额5万封顶
def signing_and_sales_incentive_feb_beijing():
    contract_data_filename = TEMP_CONTRACT_DATA_FILE_BJ_FEB
    performance_data_filename = PERFORMANCE_DATA_FILENAME_BJ_FEB
    status_filename = STATUS_FILENAME_BJ_FEB
    api_url = API_URL_BJ_FEB

    logging.info('BEIJING 2025 2月, Job started ...')

    response = send_request_with_managed_session(api_url)
 
    logging.info('BEIJING 2025 2月, Request sent')
    ...
    logging.info(f'BEIJING 2025 2月, Data saved to {contract_data_filename}')
    ...
    # 当月的数据处理逻辑
    processed_data = process_data_feb_beijing(contract_data, existing_contract_ids,housekeeper_award_lists)
    logging.info('BEIJING 2025 2月, Data processed')
    ...
    # 当月的数据处理逻辑
    notify_awards_feb_beijing(performance_data_filename, status_filename)

    archive_file(contract_data_filename)
    logging.info('BEIJING 2025 2月, Data archived')

    logging.info('BEIJING 2025 2月, Job ended')
...
# 2025年3月，上海. 签约和奖励播报
def signing_and_sales_incentive_mar_shanghai():
    contract_data_filename = TEMP_CONTRACT_DATA_FILE_SH_MAR
    performance_data_filename = PERFORMANCE_DATA_FILENAME_SH_MAR
    status_filename = STATUS_FILENAME_SH_MAR
    api_url = API_URL_SH_MAR

    logging.info('SHANGHAI 2025 3月 Conq & triumph, take 1 more city, Job started ...')
    response = send_request_with_managed_session(api_url)
    logging.info('SHANGHAI 2025 3月 Conq & triumph, take 1 more city, Request sent')
    ...
    logging.info(f'SHANGHAI 2025 3月 Conq & triumph, take 1 more city, Data saved to {contract_data_filename}')
    ...
    logging.info('SHANGHAI 2025 3月 Conq & triumph, take 1 more city, Data processed')
    ...
    archive_file(contract_data_filename)
    logging.info('SHANGHAI 2025 3月 Conq & triumph, take 1 more city, Data archived')

    logging.info('SHANGHAI 2025 3月 Conq & triumph, take 1 more city, Job ended')   

# 2025年2月，上海. 仅做签约播报
def signing_and_sales_incentive_feb_shanghai():
    contract_data_filename = TEMP_CONTRACT_DATA_FILE_SH_FEB
    performance_data_filename = PERFORMANCE_DATA_FILENAME_SH_FEB
    status_filename = STATUS_FILENAME_SH_FEB
    api_url = API_URL_SH_FEB

    logging.info('SHANGHAI 2025 2月 Conq & triumph, take 1 more city, Job started ...')
    response = send_request_with_managed_session(api_url)
    logging.info('SHANGHAI 2025 2月 Conq & triumph, take 1 more city, Request sent')
    ...
    logging.info(f'SHANGHAI 2025 2月 Conq & triumph, take 1 more city, Data saved to {contract_data_filename}')
    ...
    logging.info('SHANGHAI 2025 2月 Conq & triumph, take 1 more city, Data processed')
    ...
    # 当月的通知数据处理逻辑
    notify_awards_shanghai_generate_message_february(performance_data_filename, status_filename, contract_data)

    archive_file(contract_data_filename)
    logging.info('SHANGHAI 2025 2月 Conq & triumph, take 1 more city, Data archived')

    logging.info('SHANGHAI 2025 2月 Conq & triumph, take 1 more city, Job ended')   
