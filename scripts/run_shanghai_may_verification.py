...
from scripts.verify_shanghai_may_equivalence import main as verify_data_processing
...
def run_verification_tests():
    ...
    # 创建报告文件
    report_file = os.path.join(results_dir, 'shanghai_may_verification_report.txt')
    
    with open(report_file, 'w', encoding='utf-8') as f:
        f.write("上海5月数据等价性验证报告\n")
        f.write("=" * 50 + "\n\n")
